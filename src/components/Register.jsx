...
const Register = () => {
  ...
  const { nombre, contraseña, correo, confirmContraseña } = inputs;
  ...
  const onSubmit = async (e) => {
    ...
    };// Muestra un mensaje de error o realiza alguna acción cuando las contraseñas no coincidan.
      
    if (nombre !== "" && contraseña !== "" && confirmContraseña !== "" && correo !== "") {
      const Usuario = {
        nombre,
        correo,
        contraseña,
      ...
      await axios
        ...
        .then((res) => {
          ...
          setInputs({ nombre: "", contraseña: "", correo: "", confirmContraseña: "" });
          setTimeout(() => {
            setMensaje("");
            navigate("/login");
          }, 1500);
    ...
    <>
      <div className={styles.formContainer}>
        ...
        <form onSubmit={(e) => onSubmit(e)}>
          ...
          <div className={styles.inputContainer}>
            <div className={styles.left}>
              <label htmlFor="confirmContraseña">ConfirmContraseña</label>
              <input
                onChange={(e) => HandleChange(e)}
